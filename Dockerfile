...
# ON REMOTE INSTANCE
# ssh -i "~/moup-macbook-air.pem" ec2-user@3.147.184.206 sudo docker pull registry.moup.io/moup-api:latest
# ssh -i "~/moup-macbook-air.pem" ec2-user@3.147.184.206 sudo docker kill moup-api
